...
@Builder
public record ResearchAnalysisResponse(
        String sessionId,
        ...
        // 4) Top 단어 (추가 예정)
        AnalyticsResponse.TopWordsResult topWords,
    ...
    public record TopWordsResult(
            List<AnalyticsResponse.TopWordsResult.Item> topWords // ex) [{"word":"프로젝트","count":23}, ...]
    ) {
